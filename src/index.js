  ...
  <h2 class = 'mywork' > My Work </h2>
    <div id = 'project-container'> 
        ...
        <div class = 'project' id = 'project-two'>
          ...
          <div class = 'project-buttons'> 
            <a href = 'https://y-puce.now.sh/' target = '_blank' class = 'view-button' id = 'view-quiz-code'> View Project</a>
            <a href = 'https://github.com/jacobflaxman1/potluck-client' target = '_blank' class = 'view-button' id = 'view-project'> View Code </a>
          </div>
      </div>
      <div class = 'project' id = 'project-three'>
        ...
        <div class = 'project-buttons'> 
          <a href = 'https://spaced-repetition.lstribli.vercel.app/' target = '_blank' class = 'view-button' id = 'view-quiz-code'> View Project</a>
